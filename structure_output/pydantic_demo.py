...
class Review(BaseModel):
    ...
    sentiment: Literal["pos", "neg"] = Field(description="Return the sentiment of the review either Negative, Postive, or Neutral")
...
result = sturctured_output.invoke(review)
print(result)
